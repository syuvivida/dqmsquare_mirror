...
(function () {
   ...
   var VIEW = function (iConf) {
     ...
     */
     ...
     this.numWidth = 50;   // Max width for display number (px)
     ...
     this.init = function () {
        ...
        for (var j=0; j < this.model.values.length; j++ ) {
           ...
           sH.fillHandleColor = this.color.handle.fillHandleColor;
     ...
     this.setColors = function() { 
        ...
        this.color.track.highlightColor = new Color( [hue, sat, val] ).hex; 
        ...
        this.color.handle.fillHandleColor = new Color( [hue_han, sat, val] ).hex; 
     ...
     this.drawMinMaxLabels = function(ctx) {
        ...
        ctx.fillText(strMin, this.xmin+x10*2, this.track.y+h28, this.numWidth);  // first label
        ctx.fillText(strMax, this.xmax-x10*2, this.track.y+h28, this.numWidth);  // last label
        return 0;
     }  // drawMinMaxLabels()
    ...
    var Track = function() {
       ...
       this.createSections = function() {
          ...
          for (var j=0; j < arr.length - 1; j++ ) {
             ...
             if (j % 2 == 1) section.highlight = true;  // if even: highlight
             sections[j] = section;
          }
          return sections;
       }  // createSections()
   ...
   var Handle = {
      ...
      draw: function(ctx) {
         ...
         ctx.fillStyle = this.fillHandleColor;
